...
const CompletedHealth = () => {
    ...
    const abbreviatedLabels = [
        "Health Form", // Completed Applications
        "Sub Housing", // Awaiting Decision
        "Skip Housing",
    ];

    // Full labels for web
    const fullLabels = [
        "Submitted Health Form",
        "Submitted Housing Form",
        "Skipped Housing Form",
    ];
    const options = {
        responsive: true,
        indexAxis: 'y',
            ...
            <div className='border-[1px] rounded-lg flex justify-center'>
                <div className='sm:w-[90%] sm:py-10 w-[100%] py-2'>
                    <div className='flex justify-between'>
                        <div className='font-bold'>Student Health & Housing Statistics by Stage</div>
...
export default CompletedHealth
