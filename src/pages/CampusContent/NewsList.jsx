...
const NewsList = () => {
    ...
    const [data, setData] = useState([
        {
            date: "12-08-2023",
            name: "Innovative Initiatives and Promising Progress in the new University",
        ...
        {
            date: "13-08-2023",
            name: "Exploring the Frontiers of Space",
        ...
        {
            date: "14-08-2023",
            name: "Art and Culture Extravaganza",
    ...
    const columns = [
        ...
        },
        {
            ...
            render: (_, record) => (
                <Space>
                    <span className='capitalize'>{record.name.slice(0, 52) + "..."}</span>
                </Space>
            ),
        },
        {
            ...
            render: (_, record) => (
                <div className='capitalize'>{record.description.slice(0, 120) + "..."}</div>
            ),
            width: 500,
        },
        {
